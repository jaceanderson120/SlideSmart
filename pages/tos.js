...
const TOS = () => {
  return (
    <>
      <Head>
        <title>SolaSlides - TOS and Privacy Policy</title>
        <meta
          name="description"
          content="SolaSlides's Terms of Service and Privacy Policy"
        />
        <link rel="canonical" href="https://www.solaslides.com/tos" />
      </Head>
      ...
      <main>
        <Container>
          ...
          <Text>
            Welcome to SolaSlides. By accessing or using our service, you agree
            to the terms outlined in this document. If you do not agree to these
            terms, please refrain from using our services.
          </Text>

          <SectionTitle>1. Acceptance of Terms</SectionTitle>
          <Text>
            By using SolaSlides (“the Service”), you agree to be bound by these
            Terms of Service ("Terms"). These Terms apply to all visitors,
          ...
          <Text>
            ...
            embedding rules, ensuring that embedded players retain their
            intended functionality, including maintaining a minimum viewport of
            200px by 200px, and that no restrictions are placed on video
            playback or other core YouTube functionalities.
          </Text>

          <SectionTitle>4. Ethical Standards and Responsible Use</SectionTitle>
          <Text>
            SolaSlides is committed to upholding ethical standards, especially
          ...
          <Text>
            We recognize the importance of safeguarding user-uploaded materials
            that may be sensitive or intended to remain private. SolaSlides is
            committed to transparency in data handling practices. While we do
            not store data for model training, user-uploaded data may be used by
            OpenAI to improve future models, in accordance with OpenAI’s
          ...
          <Text>
            ...
            confidential or copyrighted. SolaSlides securely stores files that
            ...
            create study guides. Users are not permitted to upload material they
            do not have the right to use, and SolaSlides does not encourage or
            condone violations of academic integrity or the misuse of its
            services.
          </Text>

          <SectionTitle>7. Data Usage and Privacy</SectionTitle>
          <Text>
            We do not sell any user data. Data that is sent to the Azure OpenAI
            API is not used to train or improve their models and is not used for
            marketing purposes. According to Azure OpenAI's policies, your
            prompts (inputs) and completions (outputs), your embeddings, and
            your training data:
          </Text>
          <List>
          ...
          <Text>
            Study guides generated by SolaSlides are created using artificial
            ...
            always be accurate or complete. Users should verify the information
            and use it as a supplementary resource.
          </Text>

          <SectionTitle>9. Changes to the Terms</SectionTitle>
          <Text>
            We reserve the right to modify or replace these Terms at any time.
            We will provide notice of such changes by posting the updated terms
            on our website.
          </Text>
          ...
          <Text>
            ...
            property of SolaSlides or its content suppliers.
          </Text>

          <SectionTitle>11. Limitation of Liability</SectionTitle>
          <Text>
            To the fullest extent permitted by law, SolaSlides and its
        ...
        <Container>
          ...
          <Text>
            At SolaSlides, we respect your privacy and are committed to
          ...
          <List>
            <ListItem>
              ...
              an individual, such as your name and email address.
            </ListItem>
            <ListItem>
          ...
          <Text>
            ...
            However, we cannot guarantee complete security. Therefore, while we
            strive to protect your personal information, we cannot ensure
            absolute security and accept no liability for breaches beyond our
            reasonable control.
          </Text>
          ...
          <Text>
            ...
            protect our rights, privacy, safety, or property, as well as that of
            our users and the public. If third parties are involved, they will
          ...
          <Text>
            SolaSlides is committed to ethical practices, particularly regarding
            intellectual property and the privacy of educational materials. We
            are mindful of the privacy concerns of users who may upload
            sensitive content. Data stored by us may be used by OpenAI for model
            training, in line with OpenAI’s and our policies. SolaSlides ensures
            that its privacy policy aligns with YouTube’s data guidelines and
            promotes transparency regarding data use.
          </Text>
