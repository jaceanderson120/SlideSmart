  ...
  return (
    <>
      ...
      <Container>
        ...
        <Text>
          <Strong>Effective Date:</Strong> 11/22/2024
        </Text>
        ...
        <Text>
          ...
          learning. Additionally, given the potential for GPT-generated content
          inaccuracies, we are working to develop measures to verify
        ...
        <Text>
          ...
          that may be sensitive or intended to remain private. SlideSmart is
          committed to transparency in data handling practices. While we do not
          store data for model training, user-uploaded data may be used by
          OpenAI to improve future models, in accordance with OpenAI’s policies
          and industry standards.
        </Text>

        <SectionTitle>6. Changes to the Terms</SectionTitle>
        <Text>
      ...
      <Container>
        ...
        <Text>
          ...
          strive to protect your personal information, we cannot ensure absolute
          security and accept no liability for breaches beyond our reasonable
          control.
        </Text>
        ...
        <Text>
          ...
          regulation, or when we believe such disclosure is necessary to protect
          our rights, privacy, safety, or property, as well as that of our users
          and the public. If third parties are involved, they will only receive
          the information necessary to perform their function.
        </Text>

        <SectionTitle>7. Ethical Standards and Data Transparency</SectionTitle>
        <Text>
          SlideSmart is committed to ethical practices, particularly regarding
          intellectual property and the privacy of educational materials. We are
          mindful of the privacy concerns of users who may upload sensitive
          content. Data stored by us may be used by OpenAI for model training,
          in line with OpenAI’s and our policies. SlideSmart ensures that its
          privacy policy aligns with YouTube’s data guidelines and promotes
